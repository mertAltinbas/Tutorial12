...
{
    [DbContext(typeof(Tut12Context))]
    partial class Tut12ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CountryTrip", b =>
                {
                    b.HasOne("Tutorial12.Models.Country", null)
                        .WithMany()
                        .HasForeignKey("IdCountry")
                        .IsRequired()
                        .HasConstraintName("Country_Trip_Country");

                    b.HasOne("Tutorial12.Models.Trip", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tutorial12.Models.ClientTrip", b =>
                {
                    b.HasOne("Tutorial12.Models.Client", "IdClientNavigation")
                        .WithMany("ClientTrips")
                        .HasForeignKey("IdClient")
                        .IsRequired()
                        .HasConstraintName("Table_5_Client");

                    b.HasOne("Tutorial12.Models.Trip", "IdTripNavigation")
                        .WithMany("ClientTrips")
                        .HasForeignKey("IdTrip")
                        .IsRequired()
